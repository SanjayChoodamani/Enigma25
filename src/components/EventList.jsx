...
import { nationalData, designBuild, paperData, onlineData, funData } from '../assets/data/EventData'; 
    ...
    return (
        <section className="w-full bg-black min-h-screen relative overflow-hidden py-12 px-4 sm:px-6 lg:px-8 mt-16">
            ...
            <div className="relative z-10 max-w-7xl mx-auto">
                {/* National Events */}
                <div id="npp" className="mb-24">
                    <h1 className="text-white text-3xl sm:text-4xl md:text-5xl font-bold mb-12 relative inline-block">
                        <span className="relative z-10">EVENTS</span>
                        <span className="absolute -left-1 -top-1 text-teal-400 opacity-30 blur-sm z-0">EVENTS</span>
                        ...
                        {nationalData.map((data, index) => (
                            <EventContainer
                                ...
                                content={{
                                    ...
                                    eventId: data.id,          // Add this
                                    eventCategory: "national"  // Add this
                                }}
                            />
                        ))}
                    </div>
                ...
                <div id="design-build" className="mb-24">
                    <h1 className="text-white text-3xl sm:text-4xl md:text-5xl font-bold mb-12 relative inline-block">
                        <span className="relative z-10">DESIGN AND BUILD EVENT</span>
                        <span className="absolute -left-1 -top-1 text-teal-400 opacity-30 blur-sm z-0">DESIGN AND BUILD EVENT</span>
                        <div className="mt-2 h-1 w-24 bg-gradient-to-r from-purple-600 to-teal-400"></div>
                    </h1>

                    <div className="space-y-12">
                        {designBuild.map((data, index) => (
                            <EventContainer
                                key={`design-${index}`}
                                content={{
                                    imgURL: data.imgloc,
                                    ...
                                    register: data.registerForm,
                                    eventId: data.id,          // Add this
                                    eventCategory: "designBuild"  // Add this
                                }}
                            />
                        ))}
                    </div>
                ...
                {/* Paper Events */}
                <div id="paper" className="mb-24">
                    <h1 className="text-white text-3xl sm:text-4xl md:text-5xl font-bold mb-12 relative inline-block">
                        <span className="relative z-10">PAPER EVENTS</span>
                        <span className="absolute -left-1 -top-1 text-teal-400 opacity-30 blur-sm z-0">PAPER EVENTS</span>
                        <div className="mt-2 h-1 w-24 bg-gradient-to-r from-purple-600 to-teal-400"></div>
                    </h1>
                        ...
                        {paperData.map((data, index) => (
                            <EventContainer
                                ...
                                content={{
                                    ...
                                    eventContact: data.contact,
                                    eventId: data.id,          // Add this
                                    eventCategory: "paperEvent"  // Add this
                                }}
                            />
                        ))}
                    </div>
                ...
                {/* Online Events */}
                <div id="online" className="mb-24">
                    <h1 className="text-white text-3xl sm:text-4xl md:text-5xl font-bold mb-12 relative inline-block">
                        <span className="relative z-10">ONLINE EVENTS</span>
                        <span className="absolute -left-1 -top-1 text-teal-400 opacity-30 blur-sm z-0">ONLINE EVENTS</span>
                        <div className="mt-2 h-1 w-24 bg-gradient-to-r from-purple-600 to-teal-400"></div>
                    </h1>
                        ...
                        {onlineData.map((data, index) => (
                            <EventContainer
                                ...
                                content={{
                                    ...
                                    eventContact: data.contact,
                                    eventId: data.id,          // Add this
                                    eventCategory: "onlineEvent"  // Add this
                                }}
                            />
                        ))}
                    </div>
                ...
                {/* Fun Events */}
                <div id="fun" className="mb-24">
                    <h1 className="text-white text-3xl sm:text-4xl md:text-5xl font-bold mb-12 relative inline-block">
                        <span className="relative z-10">FUN EVENTS</span>
                        <span className="absolute -left-1 -top-1 text-teal-400 opacity-30 blur-sm z-0">FUN EVENTS</span>
                        <div className="mt-2 h-1 w-24 bg-gradient-to-r from-purple-600 to-teal-400"></div>
                    </h1>
                        ...
                        {funData.map((data, index) => (
                            <EventContainer
                                ...
                                content={{
                                    ...
                                    eventContact: data.contact,
                                    eventId: data.id,          // Add this
                                    eventCategory: "funEvent"  // Add this
                                }}
                            />
                        ))}
                    </div>
...
const EventContainer = (props) => {
    const {
        ...
        eventLoc,
        eventDesc,
        eventCategory, // Add category prop
        eventId // Add ID prop
    } = props.content;

    return (
        <div className="bg-purple-950/20 backdrop-blur-sm rounded-xl overflow-hidden border border-purple-800/20 hover:border-teal-400/30 transition-all duration-300 hover:shadow-[0_0_20px_rgba(45,212,191,0.1)] group mb-8">
